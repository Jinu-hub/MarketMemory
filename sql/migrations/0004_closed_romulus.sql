...
ALTER TABLE "ocr_job_pages" ADD CONSTRAINT "ocr_job_pages_job_id_ocr_jobs_id_fk" FOREIGN KEY ("job_id") REFERENCES "public"."ocr_jobs"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
CREATE UNIQUE INDEX "ocr_job_pages_job_id_page_no_unique" ON "ocr_job_pages" USING btree ("job_id","page_no");--> statement-breakpoint
CREATE INDEX "idx_ocr_job_pages_job_id_page_no" ON "ocr_job_pages" USING btree ("job_id","page_no");--> statement-breakpoint
