...
begin
  ...
  loop
    ...
    select *
    into v_regen_result
    from public.regenerate_similarity_edges_once(v_ready_source_id, p_method_version);

    v_total_inserted := v_total_inserted + coalesce(v_regen_result.inserted_count, 0);
