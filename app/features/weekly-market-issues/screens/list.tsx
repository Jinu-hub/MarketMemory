/**
 * Weekly Global Market Issues — Series Landing (/weekly-market-issues)
 *
 ...
 * `report_series.slug = weekly-market-issues`.
 *
...
export default function WeeklyMarketIssuesList({
  ...
  const buildPageHref = (nextPage: number) => {
    ...
    return weeklyMarketIssuesListPath(next.toString());
  };
