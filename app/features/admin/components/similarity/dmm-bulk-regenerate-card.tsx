...
export function DmmBulkRegenerateCard({
  candidateCount,
  readyCount,
  returnSearch,
  busy,
  ...
  return (
    <>
          ...
          <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
            <div className="space-y-1">
              ...
              <p className="text-muted-foreground text-xs leading-relaxed">
                ...
                순차 재계산합니다. 동일 <code className="text-foreground">market_scope</code>·
                <code className="text-foreground">final</code> 대상만 비교합니다.
              </p>
            </div>
            ...
            <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
              <div className="space-y-1">
                ...
                <p className="text-muted-foreground text-xs leading-relaxed">
                  ...
                  <span className="text-foreground font-mono">ready</span>인 메모리{" "}
      ...
      <AdminConfirmDialog
        ...
        description={`임베딩 후보 ${candidateCount}건에 대해 기존 엣지를 지우고 RPC 결과로 다시 채웁니다.`}
        confirmLabel="진행"
        cancelLabel="취소"
        tone="danger"
